...
I am a first-year PhD candidate at the [HKUST NLP Group](https://www.cs.ust.hk/~junxianh/), supervised by [Professor Junxian He](https://www.cs.ust.hk/~junxianh/). My research focuses on natural language processing and machine learning, with particular interests in:
...
I graduated from Shanghai Jiao Tong University in June 2024 and received the Zhiyuan Honor Scholarship during my undergraduate studies.
...
2. **On the Perception Bottleneck of VLMs for Chart Understanding**  
   *Junteng Liu*, Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He  
   Arxiv 2025  
   [GitHub: Vision4Chart](https://github.com/Vicent0205)
...
3. **On the Universal Truthfulness Hyperplane Inside LLMs**  
   *Junteng Liu*, Shiqi Chen, Yu Cheng, Junxian He  
   EMNLP 2024  
   [GitHub: Universal_Truthfulness_Hyperplane](https://github.com/Vicent0205)
...
- **Google Scholar**: [scholar.google.com/citations?user=tbK9jl4AAAAJ](https://scholar.google.com/citations?hl=en&user=tbK9jl4AAAAJ&view_op=list_works&sortby=pubdate)
